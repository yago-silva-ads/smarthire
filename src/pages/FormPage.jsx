        ...
        <div className="card form-card anim-fade-up">
            ...
            <div className="form-body">
              ...
              <div className="form-row">
                <div className="field">
                  ...
                  <input value={form.telefone} onChange={e => handleTelefone(e.target.value)} placeholder="(11) 99999-9999" inputMode="numeric" />
          ...
          {step === 3 && (
            <div className="form-body">
              ...
              <div className="field">
                <label>Projetos ou experiência relevante (opcional)</label>
                <textarea
                  rows={4}
                  value={form.projetos}
                  onChange={e => set("projetos", e.target.value)}
                  placeholder="Descreva projetos pessoais, contribuições open-source, experiência de estágio..."
                />
              </div>

              <div className="form-summary">
                <p className="form-summary__title">Resumo do seu currículo</p>
                <div className="form-summary__grid">
                  <span>Nome</span><strong>{form.nome}</strong>
                  <span>Curso</span><strong>{form.curso}</strong>
                  <span>Semestre</span><strong>{form.semestre}º</strong>
                  <span>Skills</span><strong>{form.habilidades.length} selecionadas</strong>
                </div>
              </div>
            </div>
          )}
